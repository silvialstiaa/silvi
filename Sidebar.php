            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav nav-pills flex-column justify-content-end flex-grow-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link ps-2 <?php echo (isset($_GET['x']) && $_GET['x'] == 'DaftarMenu') ? 'active link-light' : 'link-dark'; ?>"
                                href="DaftarMenu"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <li class="nav-item">
                            <a class="nav-link ps-2 <?php echo (isset($_GET['x']) && $_GET['x'] == 'KategoriMenu') ? 'active link-light' : 'link-dark'; ?>"
                                href="KategoriMenu"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <li class="nav-item">
                            <a class="nav-link ps-2 <?php echo (isset($_GET['x']) && $_GET['x'] == 'Dapur') ? 'active link-light' : 'link-dark'; ?>"
                                href="Dapur"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
